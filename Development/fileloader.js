...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 176412, 0, 0).open('GET', '/mainData');
    new DataRequest(176412, 176791, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(176791, 483927, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(483927, 2044299, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2044299, 2558407, 0, 0).open('GET', '/Resources/unity_builtin_extra');
